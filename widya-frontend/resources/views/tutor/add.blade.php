                        ...
                        <form role="form" id="form-save">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="nama" class="form-control" id="nama" placeholder="Nama Tutor" required>
                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email Tutor" required>
                                </div>
                                <div class="form-group">
                                    <label for="roles">Tipe User</label>
                                    <select class="select2" style="width: 100%;" name="roles" id="roles">
                                        @foreach($data as $key => $v)
                                        <option value="{{$data[1]['roles_id']}}">{{$data[1]['roles_name']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="alamat">Alamat</label>
                                    <textarea name="alamat" class="form-control" id="alamat" placeholder="Alamat Tutor" required></textarea>
                                </div>
                            </div>
